...
/* ─────────────────────── Main Component ─────────────────────── */
/** @param {{ variant?: "page" | "embed" }} props — `embed` : panneau compact (popup flottante), même logique métier. */
const HealthcareChatbot = ({ variant = "page" }) => {
  ...
  return (
    <div className={isEmbed ? "hc-chatbot-page hc-chatbot-embed" : "hc-chatbot-page"}>
      {/* Header (masqué en mode popup — titre dans la fenêtre flottante) */}
      {!isEmbed && (
